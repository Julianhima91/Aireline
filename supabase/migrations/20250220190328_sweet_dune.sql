/*
  # Update Route Tracking Function

  1. Changes
    - Drop existing function and recreate with proper constraints
    - Add unique index for route tracking
    - Update function to handle upserts properly
