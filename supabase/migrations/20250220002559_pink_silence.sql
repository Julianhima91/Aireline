/*
  ...
  1. Changes
    ...
    - Create function for calculating group rates
    - Update commission calculation with group discounts

  2. New Features
    - Progressive discounts for group bookings
    - Separate standard and discounted rates
    - Detailed commission breakdown
*/

-- Add columns to commission_rules for group discounts
ALTER TABLE commission_rules
ADD COLUMN IF NOT EXISTS group_discount_rules jsonb DEFAULT NULL;
...
-- Create new commission calculation function
