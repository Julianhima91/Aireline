/*
  # Update SEO URL Generation with Format Fields

  1. Extensions
    - Enable unaccent extension for character normalization

  2. Functions
    - sanitize_url_part: Handles special characters and formatting
    - generate_template_url: Uses nga_format and per_format from seo_location_formats
    - update_connection_template_url: Trigger function for automatic URL updates

  3. Changes
    - Uses nga_format and per_format directly from seo_location_formats
    - Improved URL sanitization and formatting
